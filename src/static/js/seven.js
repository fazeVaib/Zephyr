(
    function() {
        ...
        $.get('/statistics-data', (data) => {
            ...
            NallData = data.state_high_rspm;
            // console.log(NallData);
            seventhGraph(NallData);

        })
    }
)();

function seventhGraph(data){

        let allData = data;
        console.log("Seven",allData);
